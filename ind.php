...
<body>
    ...
    <!-- <h1>Create</h1> -->
   <div class="container">
    <form action="php/c.php" method="POST">
        <h4 class="display-4 text-center">Confirmation Tab</h4><hr><br>
        ...
        <button type="submit" class="btn btn-primary" name="Date">Update</button>
